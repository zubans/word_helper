...
class MetadataUtil {
    ...
    parseManifest(manifest) {
        ...
        props[prefix + "staticTabs.contentUrl"] =
            (_j = (_h = manifest.staticTabs) === null || _h === void 0 ? void 0 : _h.map((tab) => tab.contentUrl ? (0, crypto_1.createHash)("sha256").update(tab.contentUrl).digest("hex") : "undefined").toString()) !== null && _j !== void 0 ? _j : "";
