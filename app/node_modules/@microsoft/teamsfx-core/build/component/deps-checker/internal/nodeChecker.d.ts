...
export declare abstract class NodeChecker implements DepsChecker {
    ...
    protected abstract getVersionNotSupportedError(supportedVersions: string[], version: NodeVersion): UserError;
    ...
    getDepsInfo(isInstalled: boolean, supportedVersions: string[], installVersion?: string, error?: FxError): Promise<DependencyStatus>;
...
export declare class LtsNodeChecker extends NodeChecker {
    ...
    protected getVersionNotSupportedError(supportedVersions: string[], version: NodeVersion): UserError;
}
