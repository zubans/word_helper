...
export declare class AadAppClient {
    ...
    createAadApp(displayName: string, signInAudience?: SignInAudience, serviceManagementReference?: string): Promise<AADApplication>;
    ...
    clientSecretDescription?: string): Promise<string>;
