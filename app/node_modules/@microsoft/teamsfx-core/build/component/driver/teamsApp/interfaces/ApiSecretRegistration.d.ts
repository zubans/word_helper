...
export declare enum ApiSecretRegistrationAppType {
    SpecificApp = "SpecificApp",
    AnyApp = "AnyApp"
}
export declare enum ApiSecretRegistrationTargetAudience {
    HomeTenant = "HomeTenant",
    AnyTenant = "AnyTenant"
}
export declare enum ApiSecretRegistrationUserAccessType {
    Read = "Read",
    ReadWrite = "ReadWrite"
}
...
//# sourceMappingURL=ApiSecretRegistration.d.ts.map