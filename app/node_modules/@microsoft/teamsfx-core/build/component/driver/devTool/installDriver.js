...
let ToolsInstallDriver = class ToolsInstallDriver {
    constructor() {
        this.description = (0, constant_1.toolsInstallDescription)();
        this.progressTitle = (0, localizeUtils_1.getLocalizedString)("driver.prerequisite.progressBar");
    }
    ...
    async _run(args, wrapContext, outputEnvVarNames) {
        return (0, common_1.wrapRun)(async () => {
